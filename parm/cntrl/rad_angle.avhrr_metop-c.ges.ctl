dset ^avhrr_metop-c.%y4%m2%d2%h2.ieee_d       
options template big_endian sequential
undef -999.
title avhrr      metop-c       3
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    3 , iuse=  1 , error=    0.600 , wlth=      3.74 , freq=  80166.80
*  y=    2, channel=    4 , iuse=  1 , error=    0.680 , wlth=     10.76 , freq=  27855.01
*  y=    3, channel=    5 , iuse=  1 , error=    0.720 , wlth=     12.08 , freq=  24818.36
