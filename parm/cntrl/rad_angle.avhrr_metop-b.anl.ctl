dset ^avhrr_metop-b_anl.%y4%m2%d2%h2.ieee_d   
options template big_endian sequential
undef -999.
title avhrr      metop-b       3
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    3 , iuse=  1 , error=    0.450 , wlth=      3.75 , freq=  79954.95
*  y=    2, channel=    4 , iuse=  1 , error=    0.550 , wlth=     10.72 , freq=  27960.07
*  y=    3, channel=    5 , iuse=  1 , error=    0.600 , wlth=     11.92 , freq=  25148.33
