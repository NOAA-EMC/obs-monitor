dset ^avhrr_n18_anl.%y4%m2%d2%h2.ieee_d       
options template big_endian sequential
undef -999.
title avhrr      n18           3
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    3 , iuse=  1 , error=    0.600 , wlth=      3.76 , freq=  79834.87
*  y=    2, channel=    4 , iuse=  1 , error=    0.680 , wlth=     10.78 , freq=  27808.68
*  y=    3, channel=    5 , iuse=  1 , error=    0.720 , wlth=     12.00 , freq=  24979.37
