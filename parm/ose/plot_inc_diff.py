...
anldiffpath = '/scratch2/NCEPDEV/stmp1/Cory.R.Martin/apr2025/raobs/diff/gdas.20250310/12/atmos/gdas.t12z.atmanl.nc'
...
fig.save_figure('/scratch2/NCEPDEV/stmp1/Cory.R.Martin/apr2025/raobs/figs/anl_800_tmp_diff_2025031012.png')
...
fig.create_figure()
fig.plot_logo(loc='lower right', subplot_orientation='first', zoom=0.5, alpha=0.9)
fig.save_figure('/scratch2/NCEPDEV/stmp1/Cory.R.Martin/apr2025/raobs/figs/anl_800_u_diff_2025031012.png')
...
fig.create_figure()
fig.plot_logo(loc='lower right', subplot_orientation='first', zoom=0.5, alpha=0.9)
fig.save_figure('/scratch2/NCEPDEV/stmp1/Cory.R.Martin/apr2025/raobs/figs/anl_ps_diff_2025031012.png')